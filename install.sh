...
fish eza fzf starship zed mpv qt5-wayland qt6-wayland qbittorrent papirus-icon-theme gsettings-desktop-schemas gnome-themes-extra gtk-engine-murrine nwg-look"
